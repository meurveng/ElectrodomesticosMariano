...
@section("nav")
  ...
  <span class="navbar-text">
    <a href="tel:+34{{$provinciasTelefonos[$provincia]}}">
      Llama al {{$provinciasTelefonosEspaciados[$provincia]}}</a>
  </span>
@endsection
<main>
  <div class="container">
  ...
  <section class="bg-light py-5"
    <div class="container">
      <div class="row justify-content-around">
        <div class="col col-xs-12 col-sm-12 col-md-5 col-lg-5 text-center">
          <p class="display-2 col-xs-12 border-top border-bottom border-primary">
            <a href="tel:+34{{$provinciasTelefonos[$provincia]}}">
              {{$provinciasTelefonosEspaciados[$provincia]}}</a></p>
          <h1 class="display-2 border-top border-bottom border-primary text-primary">Teléfono</h1>
        </div>
        <div class="col col-xs-12 col-sm-12 col-md-5 col-lg-5">
          ...
          <p class="mb-0 pb-0 encabezado">Atendemos en todo {{$provinciasNombres[$provincia]}}</p>
  ...
  <section class="container py-3">
    ...
    <div class="row">
      ...
      <div class="col col-3">
        ...
        <h3 class="text-center pt-2">Aires Acondicionados (Split y portátiles)</h3>
      </div>
      <div class="col col-3">
    ...
    <div>
      <div class="row">
        <div class="col col-xs-12 col-sm-6 col-md-4 col-lg-4 bootstrap-gutter">
          ...
          <p class="text-justify">Líderes en servicio técnico de la zona</p>
        </div>
        <div class="col col-4">
    ...
    <div class="row py-4">
      <div class="col-5">
        <img src="{{asset('images/experiencia.jpg')}}"
          class="mx-auto d-block rounded img-fluid imagenElectrodomestico" alt="Experiencia inmejorable"/>
      </div>
      <div class="col">
        <h2>Experiencia</h2>
    ...
    <div class="row py-4">
      <div class="col-5">
        <img src="{{asset('images/repuestosoriginales.png')}}"
          class="mx-auto d-block rounded img-fluid imagenElectrodomestico" alt="Repuestos originales"/>
      </div>
      <div class="col">
...
@section("telefonoContacto")
  <li>Teléfono: <a class="text-light" href="tel:+34{{$provinciasTelefonos[$provincia]}}">
    {{$provinciasTelefonosEspaciados[$provincia]}}</a></li>
@endsection
