...
<main>
      ...
      <div class="row justify-content-around">
        ...
        <div class="col col-12 col-sm-12 col-md-4 col-lg-4 py-3">
          <div class="card bg-danger text-white">
            ...
            <div class="card-body">
              <h3 class="card-title text-center">Técnicos con gran experiencia en Aires Acondicionados.</h3>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="py-5 bg-dark text-light">
    <div class="container">
      ...
      <p id="textoPrincipal" class="text-jusfity">Reparamos su Aire Acondicionado
  ...
  <section id="descripcion" class="container py-5">
    <p class="text-justify">Desde hace muchos años nos hemos convertido en una
      ...
      los servicios de <span class="font-weight-bold">reparación e instalación de Aire Acondicionado {{$marca}}</span>.</p>
    ...
    <p class="text-justify">La profesionalidad y eficacia de nuestros técnicos
      ...
      máximas garantías en la reparación de su Aire Acondicionado {{$marca}}.</p>
  ...
  <section class="container">
    <div class="row py-4">
      <div class="col-12 col-sm-5 col-md-5 col-lg-5 bootstrap-gutter">
        <img src="{{asset('images/experienciaaa.jpg')}}"
      ...
      <div class="col">
        ...
        <p class="text-justify">Con muchos años de experiencia en su campo, la
          empresa está familiarizada con todo lo relacionado a los Aires Acondicionados y, por
